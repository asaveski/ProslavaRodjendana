...
<body>
   ...
   <div style="margin:0; padding:0; min-height:400px; background-color:#f1f1f1;">
    ...
    <form action="${pageContext.request.contextPath}/rezervacija/zakazivanje" method="post">
      <h3>${poruka}</h3>
		Agencija:
        <select name="agencijaId">
          ...
          <input type="checkbox" id="klovn" name="klovn" value="klovn">
			...
			<label for="igraonica">Igraonica</label><br>

        	<p>Trenutni broj poena: ${trenutniPoeni}</p>
          <label for="inputAddress">Unos poena za popust:</label>
          <input required="true" type="number" name="poeni" value="0"  id="inputAddress">
      
      <br><br><button type="submit">Rezervisi</button><br><br> 
    </form>
  </div>
