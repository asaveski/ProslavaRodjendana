...
<body>
        ...
        <div style="background-color:#CED2CC; min-height:30px; margin:0; padding:0">
                    	...
                    	<%}else { %>
                    	<a href="${pageContext.request.contextPath}/authentication/login" style=""> Prijava </a>
...
<hr>
		<c:forEach items="${agencije}" var="agencija">
        	<h5>Naziv: ${agencija.naziv}</h5>
        	<h5>Adresa: ${agencija.adresa}</h5>
        	<h5>Kontakt: ${agencija.telefon}</h5>
        	<h5>Osnovni paket: ${agencija.ponuda.osnovni} din</h5>
        	<h5>Gazirani sok: ${agencija.ponuda.gaziraniSok} din/l</h5>
        	<h5>Negazirani sok: ${agencija.ponuda.negaziraniSok} din/l</h5>
        	<h5>Klovn: ${agencija.ponuda.klovn} din</h5>
        	<h5>Diskoteka: ${agencija.ponuda.diskoteka} din</h5>               
       	 	<h5>Sportske igre: ${agencija.ponuda.sportskeIgre} din</h5>
        	<h5>Igraonica: ${agencija.ponuda.igraonica} din</h5>
        
       <c:if test="${role == 'ADMIN'}">
       	<a href="${pageContext.request.contextPath}/agencija/obrisi/?id=${agencija.id}">Obriši agenciju</a>
       	<a href="${pageContext.request.contextPath}/agencija/izmeni/?id=${agencija.id}">Izmeni agenciju</a>
       </c:if>
