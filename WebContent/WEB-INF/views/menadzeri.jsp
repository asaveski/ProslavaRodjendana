   ...
   <div style="margin:0; padding:0; min-height:400px; background-color:#f1f1f1;">
			...
			<hr>
				<c:forEach items="${menadzeri}" var="menadzer">
        			<h5>Ime i prezime: ${menadzer.imePrezime}</h5>
        			<h5>Korisnicko ime: ${menadzer.username}</h5>
        			<h5>Broj telefona: ${menadzer.brojTelefona}</h5>
                   
       			<c:if test="${role == 'ADMIN'}">
       				<a href="${pageContext.request.contextPath}/menadzer/obrisi/?username=${menadzer.username}">Obriši</a>
       				<a href="${pageContext.request.contextPath}/menadzer/izmeni/?username=${menadzer.username}">Izmeni</a>
       			</c:if>
