...
<body>
    ...
    <div style="margin:0; padding:0; min-height:500px; background-color:#f1f1f1;">
                ...
                %>
                  ...
                  <a href="${pageContext.request.contextPath}/authentication/logout"> Odjava </a><br> <br> <br>
                <%
                 }
                %>
            	     
  					<h1 style="text-align:center;">Dobro došli!</h1>
  					<p style="text-align:center;"> Ovo je aplikacija za zakazivanje dečijih rodjendana </p> 
  					<p style="text-align:center;"> Kliknite ispod da zakazete rodjendan za vaše dete!</p>
  				<%
                 if(request.getSession().getAttribute("role") == "KORISNIK" || request.getSession().getAttribute("role") == "MENADZER"){ 
                %>
                <br><br><p style="text-align:center;"><a href="${pageContext.request.contextPath}/rezervacija/zakazivanje"> Zakazivanje </a></p><br><br>
                <% }%>
    	</div>
